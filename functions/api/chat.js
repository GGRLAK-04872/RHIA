...
function localReply(message,world){
  ...
  if(includesAny(text,["was ist mein künstlername","wie lautet mein künstlername","wie heiße ich als rapper","wie heisse ich als rapper","wie heiße ich als künstler","wie heisse ich als künstler"]))return"Ihr Künstlername ist Shadow Grown, Sir.";
  if(includesAny(text,["wer ist shadow grown","was ist shadow grown","wer ist shadow großen","was ist shadow großen","wer ist shadow ground","was ist shadow ground","wer ist shadow grauen","was ist shadow grauen"]))return"Shadow Grown ist Ihr Künstlername und Ihre Künstlerfigur für Ihre Musik und die kreative Welt von RH Produktion, Sir.";
